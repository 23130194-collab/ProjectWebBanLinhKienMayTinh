    ...
    <header class="header">
        <div class="header-container">
            ...
            <nav class="nav-links">
                ...
                <a href="${pageContext.request.contextPath}/gioiThieu.jsp" class="active">Giới thiệu</a>
            ...
            <div class="header-actions">
                ...
                <c:choose>
                    <c:when test="${not empty sessionScope.user}">
                        <a href="${pageContext.request.contextPath}/user-profile" class="icon-btn" title="Tài khoản của bạn">
