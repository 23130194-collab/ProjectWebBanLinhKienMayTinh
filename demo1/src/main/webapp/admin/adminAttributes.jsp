...
<head>
    ...
    <link rel="stylesheet" href="admincss/adminAttributes.css">
...
<aside class="sidebar">
    ...
    <ul class="nav-menu">
        ...
        <li class="nav-item">
            <a href="adminAttributes.html" class="nav-link active">
...
<main class="main-content">
    <div class="content-area">
        ...
        <div class="form-section">
            ...
            <div class="form-item">
                <label class="form-label">Tên thuộc tính mới</label>
        ...
        <div class="top-actions">
            <button class="btn-add">Thêm thuộc tính</button>
        ...
        <div class="table-container">
            <table class="table">
                ...
                <tr>
                    ...
                    <td><span class="badge active-status">Hoạt động</span></td>
                    <td class="actions">
                ...
                <tr>
                    ...
                    <td>2</td>
                    <td><i class="fa-solid fa-check check-icon"></i></td>
                    <td><span class="badge inactive-status">Ẩn</span></td>
                    <td class="actions">
                        <button class="btn-edit"><i class="fa-solid fa-pen"></i></button>
                        <button class="btn-delete"><i class="fa-solid fa-trash"></i></button>
                    </td>
